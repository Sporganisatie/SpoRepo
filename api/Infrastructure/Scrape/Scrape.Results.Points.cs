...
public partial class Scrape
{
    private int Score(int rank, string tab)
        => tab switch
        {
            "Stage" => rank > 20 ? 0 : new int[] { 0, 50, 44, 40, 36, 32, 30, 28, 26, 24, 22, 20, 18, 16, 14, 12, 10, 8, 6, 4, 2 }[rank],
    ...
    private int TeamScore(PcsRow pcsRow, string classification, string teamWinner, string stageType)
    {
        ...
        var teampointsDict = stageType switch
        {
            ...
            "ITT" => new Dictionary<string, int>() { { "Stage", 0 }, { "GC", 8 }, { "Points", 6 }, { "KOM", 3 }, { "Youth", 2 } },
            "TTT" => new Dictionary<string, int>() { { "Stage", 0 }, { "GC", 8 }, { "Points", 6 }, { "KOM", 3 }, { "Youth", 2 } },
            "FinalStandings" => new Dictionary<string, int>() { { "Stage", 0 }, { "GC", 24 }, { "Points", 18 }, { "KOM", 9 }, { "Youth", 6 } },
