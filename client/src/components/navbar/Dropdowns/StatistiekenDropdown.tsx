...
const StatistiekenDropdown = (props: { raceSelected: boolean }) => {
    return (
        <DropdownMenu
            ...
            raceOnlyLinks={[
                { url: "/teamcomparison/28", title: "Team overzichten" }, // TODO dynamic race id
                { url: "/etappeUitslagen/28", title: "Uitslagen per etappe" }, // TODO dynamic race id
                { url: "/allRiders/28", title: "Alle Renners" }, // TODO dynamic race id
                { url: "/missedpoints/28", title: "Gemiste punten" }, // TODO dynamic race id
                { url: "/uitvallers/28", title: "Uitvallers" }, // TODO dynamic race id
